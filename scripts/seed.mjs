...
const stores = [
  {
    ...
    setup: { branding: true, localisation: true, domain: true, payments: true, shipping: true, tax: true },
    createdAt: iso(100),
    archivedAt: null,
  },
  {
    ...
    setup: { branding: true, localisation: true, domain: false, payments: true, shipping: true, tax: true },
    createdAt: iso(60),
    archivedAt: null,
  },
  {
    ...
    pricesIncludeTax: true,
    setup: { branding: true, localisation: true, domain: false, payments: false, shipping: false, tax: false },
    createdAt: iso(9),
    archivedAt: null,
  },
  {
    ...
    defaultTaxBracketId: "tax_std20",
    pricesIncludeTax: true,
    setup: { branding: true, localisation: true, domain: false, payments: false, shipping: true, tax: true },
    createdAt: iso(150),
    archivedAt: iso(21),
  },
  {
